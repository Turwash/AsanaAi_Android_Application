...
class CameraViewModel(val database: Dao, application: Application) : AndroidViewModel(application) {
    ...
    val poseClassifierProcessor = PoseClassifierProcessor(application, true)
    ...
    class Factory(private val database: Dao, private val app: Application) : ViewModelProvider.Factory {
